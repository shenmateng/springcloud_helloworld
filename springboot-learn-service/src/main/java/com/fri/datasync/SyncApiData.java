...
/**
 * @author : 陈余银
 * @create : 2022-05-30 17:08:00
 * @description :
 */
public class SyncApiData {
    public static void main(String[] args) throws Exception {
        ...
        MySqlSource<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .databaseList(FlinkNacosConfig.getConfigValue("mysql.api.database"))
                .tableList(FlinkNacosConfig.getConfigValue("mysql.api.table"))
                .username(username)
                .password(password)
        ...
        DataStreamSource<String> commonSource = env
                .fromSource(sourceFunction, WatermarkStrategy.noWatermarks(), "sync ys_api source");

        commonSource
                .addSink(new MysqlSinkPlus(FlinkNacosConfig.getConfigValue("mysql.api.url"), username, password, driverClassName))
                .setParallelism(1);

        env.execute("Sync Api DB Data");
    }
}
