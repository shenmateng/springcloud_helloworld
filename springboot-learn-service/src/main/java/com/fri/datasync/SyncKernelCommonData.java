...
/**
 * @author : 陈余银
 * @create : 2022-05-30 16:58:00
 * @description :
 */
public class SyncKernelCommonData {
    public static void main(String[] args) throws Exception {
        ...
        MySqlSource<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .databaseList(FlinkNacosConfig.getConfigValue("mysql.kernelCommon.database"))
                .tableList(FlinkNacosConfig.getConfigValue("mysql.kernelCommon.table"))
                .username(username)
                .password(password)
        ...
        DataStreamSource<String> commonSource = env
                .fromSource(sourceFunction, WatermarkStrategy.noWatermarks(), "sync ys_kernel_common source");

        commonSource
                .addSink(new MysqlSinkPlus(FlinkNacosConfig.getConfigValue("mysql.kernelCommon.url"), username, password, driverClassName))
                .setParallelism(1);

        env.execute("Sync KernelCommon DB Data");
    }
}
