...
public class SyncCommonData {
    public static void main(String[] args) throws Exception {
        ...
        MySqlSource<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .databaseList(FlinkNacosConfig.getConfigValue("mysql.common.database"))
                .tableList(FlinkNacosConfig.getConfigValue("mysql.common.table"))
                .username(username)
                .password(password)
        ...
        DataStreamSource<String> commonSource = env
                .fromSource(sourceFunction, WatermarkStrategy.noWatermarks(), "sync ys_common source");

        commonSource
                .addSink(new MysqlSinkPlus(FlinkNacosConfig.getConfigValue("mysql.common.url"), username, password, driverClassName))
                .setParallelism(1);

        env.execute("Sync Common DB Data");
    }
}
