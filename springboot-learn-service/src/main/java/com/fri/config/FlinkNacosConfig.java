...
/**
 * @Author: chenyuyin
 * @DateTime: 2022-3-8 13:36
 * @Description:
 */
public class FlinkNacosConfig {
    private static final Logger logger = LoggerFactory.getLogger(FlinkNacosConfig.class);
    private static final String ENABLE_NACOS_KEY = "flink.nacos.enable";
    private static final String SERVER_ADDR_KEY = "flink.nacos.serverAddr";
    private static final String NAMESPACE_KEY = "flink.nacos.namespace";
    private static final String GROUPS_KEY = "flink.nacos.groups";
    private static final String DATA_IDS_KEY = "flink.nacos.dataIds";
    private static final String TIMEOUT_KEY = "flink.nacos.timeout";
    ...
    private static final String DEFAULT_CONFIG_FILE = "bootstrap.properties";

    static {
        InputStream inputStream = FlinkNacosConfig.class.getClassLoader().getResourceAsStream(DEFAULT_CONFIG_FILE);
        if (inputStream == null) {
            logger.info("Flink nacos config not found...");
        } else {
            try {
