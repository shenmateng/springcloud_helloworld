...
public class ReflectUtils {
    ...
    public static Field getField(String fieldName, Class<?> clazz) {
        ...
        if (field == null) {
            throw new NullPointerException(old + I18nUtil.get("NO") + fieldName + I18nUtil.get("ATTRIBUTES"));
        }
        return field;
    }
     ...
     * 判断属性名是否存在
     */
    public static Boolean ifFieldExist(String fieldName, Class<?> clazz) {
        Class<?> old = clazz;
        Field field = null;
        for (; clazz != Object.class; clazz = clazz.getSuperclass()) {
            try {
    ...
    public static void setValueBySetMethod(String fieldName, Object object, Object value) {
        if (object == null) {
            throw new RuntimeException(I18nUtil.get("INSTANCE_OBJECT_CANNOT_BE_EMPTY"));
        }
        if (value == null) {
            return;
        }
    ...
    public static Method getMethod(String methodName, Class<?> clazz) {
        ...
        if (method == null) {
            throw new NullPointerException(I18nUtil.get("NO") + methodName + I18nUtil.get("METHOD"));
        }
        return method;
    }
    ...
    public static Method getMethod(String methodName, Class<?> clazz, Class<?> paramType) {
        ...
        if (method == null) {
            throw new NullPointerException(clazz + I18nUtil.get("NO") + methodName + I18nUtil.get("METHOD"));
        }
        return method;
    }
